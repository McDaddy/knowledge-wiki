...
大模型推理、训练与算力系统相关知识，偏资源瓶颈、硬件分工与通信栈理解。

| Article | Summary | Updated |
|---------|---------|---------|
| [AI 算力系统：GPU、CPU、HBM 与存储的分工](ai-llm/ai-compute-system-and-memory-hierarchy.md) | 从系统工程视角解释 GPU、CPU、HBM 和存储在 AI 服务器中的角色分工。 | 2026-04-22 |
| [KV Cache 与推理资源约束](ai-llm/kv-cache-and-inference-constraints.md) | 说明 KV Cache 如何以空间换时间，以及为什么推理常先受限于显存与带宽。 | 2026-04-22 |
| [分布式训练通信栈速览](ai-llm/distributed-training-network-stack.md) | 解释 NCCL、RDMA、IB、RoCE、NVLink 和 AllReduce 的分层关系。 | 2026-04-22 |
